...
// Form menu
    ...
    $('button.btn_menu').click(function(){
        ...
        if (myId === 'add_menu') {
            flag  = true
            count++
            $("div#menu").append(`<div class="card-body" id = "menu_child${count}">
                                    <div class="form-group" >
                                        <label for="menu_child">Name Menu Child</label>
                                        <input type="text" class="form-control" name="menu_child" value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="link_child">Link Child</label>
                                        <input type="text" class="form-control" name="link_child" value="">
                                    </div>
        ...
        if (count < 1 && flag == true) {
            flag = false
            $("div#menu").append(`<div class="form-group" id="link_menu" >
